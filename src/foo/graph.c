...
const struct graph_node graph_node[GRAPH_NUM_NODE] =
{
	...
	{{  -600.00f,   450.00f},  7,  3},
	{{     0.00f,   450.00f}, 10,  3},
	{{   600.00f,   450.00f}, 13,  3},
	{{  -762.50f,   312.50f}, 16,  3},
	{{   762.50f,   312.50f}, 19,  3},
	{{ -1250.00f,   250.00f}, 22,  3},
	{{  1250.00f,   250.00f}, 25,  3},
	{{ -1250.00f,     0.00f}, 28,  2},
	{{  -800.00f,     0.00f}, 30,  4},
	{{   800.00f,     0.00f}, 34,  4},
	{{  1250.00f,     0.00f}, 38,  2},
	{{  -860.00f,  -400.00f}, 40,  3},
	{{     0.00f,  -400.00f}, 43,  3},
	{{   860.00f,  -400.00f}, 46,  3},
	{{  -860.00f,  -700.00f}, 49,  2},
	{{     0.00f,  -700.00f}, 51,  3},
	{{   860.00f,  -700.00f}, 54,  2},
};
