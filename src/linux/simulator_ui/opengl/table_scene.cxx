...
{
	-GATE_HALF_LENGTH - GATE_NP_X, -GATE_HALF_WIDTH,
	-GATE_HALF_LENGTH - GATE_NP_X, GATE_HALF_WIDTH,
	GATE_HALF_LENGTH - GATE_NP_X, GATE_HALF_WIDTH,
	GATE_HALF_LENGTH - GATE_NP_X, -GATE_HALF_WIDTH,
	-GATE_HALF_LENGTH - GATE_NP_X, -GATE_HALF_WIDTH
...
void TableScene::draw(Graphique* graph, int selectedRobot)
{
	static Vect2 pt[CONTROL_USB_DATA_MAX];
	RobotInterface* robotItf = &m_robot[selectedRobot].m_robotItf;
