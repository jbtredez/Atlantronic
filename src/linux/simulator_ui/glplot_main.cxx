...
{
	{
		...
		1,
		STAR_HALF_LENGTH, STAR_HALF_WIDTH, // coin 1 / NP
		-STAR_HALF_LENGTH, STAR_HALF_WIDTH, // coin 2 / NP
		-STAR_HALF_LENGTH, -STAR_HALF_WIDTH, // coin 3 / NP
		STAR_HALF_LENGTH, -STAR_HALF_WIDTH, // coin 4 / NP
		STAR_HOKUYO_1_X,
		STAR_HOKUYO_1_Y,
		STAR_HOKUYO_1_THETA,
		STAR_HOKUYO_2_X,
	...
	},
	{
		...
		1,
		0,
		-GATE_NP_X + GATE_HALF_LENGTH, GATE_HALF_WIDTH, // coin 1 / NP
		-GATE_NP_X - GATE_HALF_LENGTH, GATE_HALF_WIDTH, // coin 2 / NP
		-GATE_NP_X - GATE_HALF_LENGTH, -GATE_HALF_WIDTH, // coin 3 / NP
		-GATE_NP_X + GATE_HALF_LENGTH, -GATE_HALF_WIDTH, // coin 4 / NP
		GATE_HOKUYO_1_X,
		GATE_HOKUYO_1_Y,
		GATE_HOKUYO_1_THETA,
		GATE_HOKUYO_2_X,
