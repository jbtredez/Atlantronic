...
core_baz += kernel/geometric_model/geometric_model_diff.o
...
#core_baz += discovery/detection.o
...
core_baz += kernel/can_motor.o
core_baz += kernel/motion.o
#core_baz += discovery/graph.o
#core_baz += discovery/trajectory.o
