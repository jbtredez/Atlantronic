...
// code commenté : ne sert à rien à part induire l'utilisateur en erreur.
// En effet, sysconf(_SC_CLK_TCK) retourne 100 même si le noyau est à 1Khz (noyau 2.6.34, glibc 2.11.2, x86_64).
