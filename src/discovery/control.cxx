...
static void control_task(void* arg)
{
	...
	while(1)
	{
		...
		control_usb_data.raw_data_gyro = spi_gyro_get_raw_data();
		control_usb_data.omega_gyro = spi_gyro_get_omega();
		control_usb_data.pos_theta_gyro_euler = spi_gyro_get_theta_euler();
		control_usb_data.pos_theta_gyro_simpson = spi_gyro_get_theta_simpson();
