...
#define LIS320DL_STACK_SIZE            300
...
static void accelero_task(void* arg);
...
int accelero_module_init()
{
	...
	xTaskCreate(accelero_task, "lis302dl", LIS320DL_STACK_SIZE, NULL, PRIORITY_TASK_ACCELERO, NULL);
