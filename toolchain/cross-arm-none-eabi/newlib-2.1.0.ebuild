...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/newlib/newlib-2.1.0.ebuild,v 1.1 2013/12/24 06:44:18 vapier Exp $
...
src_configure() {
	...
	local myconf="--disable-newlib-atexit-alloc --disable-newlib-io-float"
	[[ ${CTARGET} == "spu" ]] \
